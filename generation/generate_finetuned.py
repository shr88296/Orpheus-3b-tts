...
voice = "tara"  # see github for other voices
...
# Initialize environment and login to hugginface
load_dotenv()
...
if len(prompts) != len(prompts_samples):
    ...
    for i, samples in enumerate(prompts_samples):
        ...
        output_filename = f"out/output_{voice}_{i}.wav"
        ...
        print(f"Saved audio sample {i} to {output_filename}")
